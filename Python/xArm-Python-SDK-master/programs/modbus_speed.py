...
# All rights reserved.
#
# Author: Vinman <vinman.wen@ufactory.cc> <vinman.cub@gmail.com> and Chris Morrey, messing it up.


import os
import sys
import time
sys.path.append(os.path.join(os.path.dirname(__file__), '../../..')) #fix this
...
# data_frame = [0x08, 0x10, 0x03, 0xE8, 0x00, 0x03, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]
