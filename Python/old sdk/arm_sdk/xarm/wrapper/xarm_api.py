...
sys.path.append("C:\\Users\\morr0289\\Documents\\Github\\RobotArm\\Python\\arm_sdk")

from arm_sdk.xarm.x3.xarm import XArm
from arm_sdk.xarm.x3.studio import Studio
...
class XArmAPI(object):
    def __init__(self, port=None, is_radian=False, do_not_open=False, **kwargs):
        ...
        :param port: ip-address(such as '192.168.1.196')
